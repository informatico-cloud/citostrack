    ...
    <div class="card-body">
      <div class="table-wrap">
        <table id="tabla">
          <thead>
            <tr>
              <th>Sel</th><th>Nombre</th><th>RUT</th><th>Fecha evaluación</th><th>Semana</th><th># Preparaciones</th><th># Administraciones</th><th>Tiempo (min)</th><th>ICC</th><th>Observaciones</th>
            </tr>
          </thead>
      ...
      <p class="hint">La <b>Semana</b> se calcula automáticamente según la fecha, y el <b>ICC</b> se actualiza en tiempo real.</p>
    </div>
  </div>
</main>
<script>
...
document.getElementById("btnLimpiar").onclick=()=>{if(confirm("¿Borrar todos los registros?")){rows=[emptyRow()];save();render();}};
